...
void print_usage(const char* prog_name) {
    std::cout << "Usage: " << prog_name << " <input.mesh> <input.field> <output.field>\n";
    std::cout << "  input.mesh    - Input mesh file (OBJ format)\n";
    std::cout << "  input.field   - Input polyvector field file\n";
...
int main(int argc, char* argv[]) {
    ...
    pvField.init(vtb, directional::fieldTypeEnum::POLYVECTOR_FIELD, 1);
    directional::read_raw_field(input_file, pvField);
